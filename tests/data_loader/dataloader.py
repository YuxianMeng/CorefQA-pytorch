...
# from data_loader.conll_data_processor import MAX_LENGTH
...
if __name__ == "__main__":
    ...
    # loader = dataloader.get_dataloader("dev")
    loader = dataloader.get_dataloader("dev1")
    ...
    #     print("flattened_input_ids: ", len(test_example["flattened_window_input_ids"].squeeze(0).numpy().tolist()[0]), test_example["flattened_window_input_ids"].squeeze(0).numpy().tolist()[0])
    #     print("flattened_input_mask: ", len(test_example["flattened_window_masked_ids"].squeeze(0).numpy().tolist()[0]), test_example["flattened_window_masked_ids"].squeeze(0).numpy().tolist()[0])
